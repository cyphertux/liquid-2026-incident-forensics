...
|---|---|---|
| Hostname in `build_env.json` (`maxime-Apple-Virtualization…`) | **PRIVATE** → redacted | Was operational host fingerprint |
| Absolute path `/home/maxime/Documents/dev/test/repro/...` | **AMBIGUOUS** → redacted/relativized | Revealed local username/layout |
