...
| Mentions of `BEGIN PRIVATE KEY` / local absolute home paths inside `final/23_publication_readiness.md` | Documentation of prior audit/redaction — **not** live secrets |
